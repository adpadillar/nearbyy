    ...
    <div className="z-20 flex max-w-[70rem] flex-col items-center space-y-4 ">
      ...
      <div className="flex flex-col items-center">
        <h1
          ...
          className=" text-center text-5xl font-bold text-white sm:text-6xl"
        >
          Empower Your Growth,
        </h1>
        <h1 className="inline-block bg-gradient-to-r from-red-600 to-[#166AE8] bg-clip-text text-center text-5xl  font-bold text-transparent  sm:text-6xl ">
          explore pricing.
        </h1>
