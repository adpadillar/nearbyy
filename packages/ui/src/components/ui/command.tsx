...
>(({ className, ...props }, ref) => (
  <div
    ...
    cmdk-input-wrapper=""
  >
    <Search className="tw-mr-2 tw-h-4 tw-w-4 tw-shrink-0" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "tw-flex tw-h-11 tw-w-full tw-rounded-md tw-py-3 tw-text-sm tw-outline-none disabled:tw-cursor-not-allowed disabled:tw-opacity-50",
        className,
      )}
      {...props}
    />
